    ...
    <div>
        <div class="fixed_topw">
	   	  <div class="self_info">
	   	  	...
	   	  	<p>当前金币<span class="red">452</span></p>
	   	  </div>
	   	  <ul>
			<li><a href="javacsript:;"><p><i class="icons">&#xe602;</i></p><h4>消息</h4></a></li>
			<li><a href="javacsript:;"><p><i class="icons">&#xe60d;</i></p><h4>兑换</h4></a></li>
			<li><a href="javacsript:;"><p><i class="icons">&#xe6b9;</i></p><h4>提现</h4></a></li>
			<li><a href="javacsript:;"><p><i class="icons">&#xe60a;</i></p><h4>充值</h4></a></li>
		  </ul>
	   </div>
        <!--主体区域-->
	   <div class="container" style="padding:60px 0">
	   	<!-- 通知信息 -->
            ...
            <div class="gz">
                <span class="red">抢购规则:</span>根据当期"揭晓号码"的最后一位数字，为单数则为"买单"抢购成功，反之"买双"抢购成功。<a href="javacsript:;">详细说明>>></a>
            </div>
...
.banner{background:url(../assets/img/bn.jpg);background-size:100% 100%;height:160px}
...
<script>
//因为使用swiper要引入jQuery，因此可以可以使用 npm install vue-swipe -S 安装更小的vue-swipe，以下是使用方式
