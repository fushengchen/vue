<template>
    <div>
        <ul class="bang_list">
            <li><img src="../assets/img/pic2.png"/><h3>不一样的卡布基诺</h3><p>已获胜<span>556</span>单</p></li>
            <li><img src="../assets/img/pic2.png"/><h3>不一样的卡布基诺</h3><p>已获胜<span>556</span>单</p></li>
            <li><img src="../assets/img/pic2.png"/><h3>不一样的卡布基诺</h3><p>已获胜<span>556</span>单</p></li>
            <li><img src="../assets/img/pic2.png"/><h3>不一样的卡布基诺</h3><p>已获胜<span>556</span>单</p></li>
            <li><img src="../assets/img/pic2.png"/><h3>不一样的卡布基诺</h3><p>已获胜<span>556</span>单</p></li>
...
<style>
    ...
    .bang_list li p{float:right;color:#999;height:50px;line-height:50px;text-align:right;padding-right:10px;width:100px;font-size:14px}
